    ...
    <nav className="flex items-center justify-between px-5 py-3" style={{ background: T.white, borderBottom: `1px solid ${T.mint}` }}>
        <div className="flex items-center gap-2.5">
            ...
            <div className="text-left">
                <p style={{ color: T.navy, fontFamily: "Outfit", fontWeight: 700, fontSize: 13, lineHeight: 1.2 }}>Dr. Akshath</p>
        ...
        <div className="flex items-center gap-2">
            ...
            <button onClick={() => setPage("profile")} className="w-8 h-8 rounded-full flex items-center justify-center transition-transform active:scale-90"
